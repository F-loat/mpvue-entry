const { resolveApp, resolveModule, resolveOptions } = require('../utils/resolve');
...
function parsePaths(paths = {}) {
  ...
  const packageOptions = resolveOptions();

  const mergedOptions = Object.assign(paramOptions, packageOptions);
